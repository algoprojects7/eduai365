...
import type { LoginResult } from '@/types/parent';

export default function LoginPage() {
  const router = useRouter();
  const [email, setEmail] = useState('parent@greenfield.eduai365.ai');
      ...
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="bento-card space-y-5">
          ...
          <p className="text-body-md text-on-surface-variant">
            Demo: <span className="font-medium text-on-surface">parent@greenfield.eduai365.ai</span> / AlgoDemo#2026
          </p>
