...
export default function SocialNetworkPage() {
  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    if (safetyStatus === 'unrelated') {
      setErrorMsg("Ollama AI Blocked: Message is irrelevant to school administrative topics. Please avoid unrelated or commercial topics.");
      return;
    }
                  ...
                  <div key={user.id} className="flex items-center justify-between gap-2.5">
                    ...
                    >
                      ...
                      <div className="text-left flex-1">
                        ...
                        <p className="text-[10px] text-slate-500 font-mono font-bold mt-0.5 uppercase tracking-wide">{user.role}</p>
                      </div>
                    </button>
                  </div>
                ))}
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm space-y-5">
              ...
              <div className="space-y-2 text-left">
                <div className="flex justify-between text-xs">
                  <span className="text-slate-500 font-medium">Relevance / Tone Score:</span>
              ...
              <div className="rounded-xl bg-slate-50 border border-slate-100 p-3.5 text-left space-y-1">
                <span className="text-xs text-slate-500 font-bold uppercase tracking-wider block">Ollama Evaluation</span>
                {safetyStatus === 'empty' && (
